...
<body class="font-poppins text-[#0E0140] pb-[100px] overflow-x-hidden bg-white">
    ...
    <div style="background: #bbdefb; padding: 50px 0;">
        <div class="container text-center">
            <h1 class="text-dark">{{ ucfirst($category->name) }}</h1>
            <p class="text-wdark">Temukan peluang kerja terbaik yang dirancang khusus untuk Anda</p>
        </div>
    </div>
    ...
    <section id="Result" class="container-xxl mt-5">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6 col-lg-4 wow animate__animated animate__fadeInUp" data-wow-delay="0.1s">
                    <div class="card border border-secondary shadow-sm h-100 position-relative" style="border-radius: 10px; padding: 10px;">
                        <!-- Company Logo --> 
                        <img src="{{ asset('images/' . $job->company->logo) }}" class="card-img-top" alt="{{ $job->company->name }} logo" style="height: 150px; object-fit: cover; border-top-left-radius: 10px; border-top-right-radius: 10px;">
        ...
        <div class="d-flex justify-content-center mt-4">
            {{ $category->jobs->links() }} <!-- Laravel pagination links -->
        </div>
    </section>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="position-relative">
                        ...
                        <button type="button" class="btn btn-primary rounded-pill position-absolute top-0 end-0">Sign Up</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="container-fluid text-center py-4">
            <p class="mb-0">&copy; <a href="#" class="text-white">Your Site Name</a>. All Rights Reserved. Designed by <a href="#" class="text-white">Your Name</a></p>
        </div>
    </div>
    <!-- Footer End -->
