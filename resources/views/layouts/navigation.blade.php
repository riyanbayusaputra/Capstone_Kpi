<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('frontend.index') }}">
                        <span class="text-2xl font-bold text-gray-800">JobHub</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @can('manage company_users')
                    <x-nav-link :href="route('company_users.index')" :active="request()->routeIs('company_users.index')">
                        {{ __('Pengguna') }}
                    </x-nav-link>
                    @endcan
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                @can('manage company')
                                <x-dropdown-link :href="route('admin.company.index')">
                                    {{ __('Perusahaan') }}
                                </x-dropdown-link>
                                @endcan
                                ...
                                @can('manage jobs')
                                <x-dropdown-link :href="route('admin.company_jobs.index')">
                                    {{ __('Daftar Pekerjaan') }}
                                </x-dropdown-link>
                                @endcan
                            </x-slot>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @can('manage company_users')
            <x-responsive-nav-link :href="route('company_users.index')" :active="request()->routeIs('company_users.index')">
                {{ __('Pengguna') }}
            </x-responsive-nav-link>
            @endcan
